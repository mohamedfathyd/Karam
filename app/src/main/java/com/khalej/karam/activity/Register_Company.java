...
public class Register_Company extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= 23) {
            int permissionCheck = ContextCompat.checkSelfPermission(Register_Company.this, Manifest.permission.WRITE_EXTERNAL_STORAGE);
            if (permissionCheck != PackageManager.PERMISSION_GRANTED) {
                ActivityCompat.requestPermissions(Register_Company.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, 1);
            }
        }
    ...
    public void fetchInfo() {
        ...
        progressDialog = ProgressDialog.show(Register_Company.this, "جاري تقديم طلبك كا صاحب مصلحة", "Please wait...", false, false);
        progressDialog.show();
        ...
        RequestBody companyname= (RequestBody) RequestBody.create(MediaType.parse("text/plain"), company.getText().toString());
        RequestBody numberId= (RequestBody) RequestBody.create(MediaType.parse("text/plain"), idnumber.getText().toString());



        apiinterface = Apiclient_home.getapiClient().create(apiinterface_home.class);
        Call<ResponseBody> call = apiinterface.getcontacts_newaccountCompany(fileToUpload,namee,
                pass, address
                ,phonee,type,city,phoneCode,is_agree,companyname,numberId);
        call.enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                if (response.code() == 422) {
                    ...
                    Toast.makeText(Register_Company.this,"هناك بيانات مستخدمة من قبل  أو تأكد من انك ادخلت البيانات بشكل صحيح",Toast.LENGTH_LONG).show();
                    Log.d("tag", jObjError.toString());
                    progressDialog.dismiss();
                    return;
                }
                progressDialog.dismiss();
                AlertDialog.Builder dlgAlert = new AlertDialog.Builder(Register_Company.this);
                dlgAlert.setMessage("تم تقديم طلبك كاصاحب مصلحة");
            ...
            public void onFailure(Call<ResponseBody> call, Throwable t) {
                progressDialog.dismiss();
                Toast.makeText(Register_Company.this, "من فضلك قم بأختيار صورة اقل فى الحجم ", Toast.LENGTH_LONG).show();
            }
        });
    }
