...
public class RecyclerAdapter_morder_cancel extends RecyclerView.Adapter<RecyclerAdapter_morder_cancel.MyViewHolder> {
    Typeface myTypeface;
    private Context context;
    List<Order> contactslist;


    public RecyclerAdapter_morder_cancel(Context context, List<Order> contactslist){
